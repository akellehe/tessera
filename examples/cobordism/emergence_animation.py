...
#: beside a unit.
# The animation itself lives in `examples/lib/animation.py`: the stable
# layout, the panel draw, the live worker/GUI split and the renderer are the
# same whatever is being animated, and a third example needed them without
# wanting this driver's panels. Imported under the names this module has
# always exported so that every call site, here and in the other drivers,
# is unchanged.
sys.path.insert(0, os.path.join(
    os.path.dirname(os.path.abspath(__file__)), os.pardir, "lib"))
import animation as _animation                                  # noqa: E402

LIVE_POLL_INTERVAL = _animation.LIVE_POLL_INTERVAL
StableLayout = _animation.StableLayout
place_frame = _animation.place_frame
stabilize = _animation.stabilize
DECLARED_LAYOUT_EASE = _animation.DECLARED_LAYOUT_EASE
DECLARED_LAYOUT_VIEW_EASE = _animation.DECLARED_LAYOUT_VIEW_EASE
DECLARED_LAYOUT_PAD = _animation.DECLARED_LAYOUT_PAD
DECLARED_PANEL_GRID = _animation.DECLARED_PANEL_GRID
DECLARED_LIVE_FIGSIZE = _animation.DECLARED_LIVE_FIGSIZE
DECLARED_RENDER_FIGSIZE = _animation.DECLARED_RENDER_FIGSIZE
_draw_frame = _animation.draw_frame
_interactive_backends = _animation.interactive_backends
_drive_live = _animation.drive_live
_render = _animation.render
